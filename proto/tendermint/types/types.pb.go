...
type Vote struct {
	...
	// Multisig tendermint
	HeaderAuxHash []byte `protobuf:"bytes,9,opt,name=header_aux_hash,json=headerAuxHash,proto3" json:"header_aux_hash,omitempty"`
	SignatureAux  []byte `protobuf:"bytes,10,opt,name=signature_aux,json=signatureAux,proto3" json:"signature_aux,omitempty"`
}
...
type Commit struct {
	...
	HeaderAuxHash []byte      `protobuf:"bytes,5,opt,name=header_aux_hash,json=headerAuxHash,proto3" json:"header_aux_hash,omitempty"`
}
...
func (m *Commit) GetHeaderAuxHash() []byte {
	if m != nil {
		return m.HeaderAuxHash
	}
	return nil
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
